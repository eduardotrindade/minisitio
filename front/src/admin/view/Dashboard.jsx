                ...
                <div className="col-md-4">
                    <div className="card text-white bg-danger mb-3">
                        <div className="card-body text-center">
                            ...
                            <h2 className="card-text">{formatNumber(data.semEmailETelefone)}</h2>
                            <small>{data.total > 0 ? ((data.semEmailETelefone / data.total) * 100).toFixed(1) : 0}% do total</small>
                        </div>
                    </div>
                </div>
                <div className="col-md-4">
                    <div className="card text-white bg-orange mb-3" style={{ backgroundColor: '#fd7e14' }}>
                        <div className="card-body text-center">
                            <h6 className="card-title"><i className="fa fa-envelope-o"></i> Sem E-mail</h6>
                            <h2 className="card-text">{formatNumber(data.semEmail)}</h2>
                            <small>{data.total > 0 ? ((data.semEmail / data.total) * 100).toFixed(1) : 0}% do total</small>
                        </div>
                    </div>
                </div>
                <div className="col-md-4">
                    <div className="card text-white mb-3" style={{ backgroundColor: '#6f42c1' }}>
                        <div className="card-body text-center">
                            <h6 className="card-title"><i className="fa fa-phone"></i> Sem Telefone</h6>
                            <h2 className="card-text">{formatNumber(data.semTelefone)}</h2>
                            <small>{data.total > 0 ? ((data.semTelefone / data.total) * 100).toFixed(1) : 0}% do total</small>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div className="card-body">
                                <table className="table table-sm">
                                    <tbody>
                                        ...
                                        <tr className="table-danger"><td>Sem E-mail</td><td className="text-end">{formatNumber(data.semEmail)}</td></tr>
                                        <tr className="table-warning"><td>Sem Telefone</td><td className="text-end">{formatNumber(data.semTelefone)}</td></tr>
                                        <tr className="table-danger"><td>Sem E-mail nem Telefone</td><td className="text-end">{formatNumber(data.semEmailETelefone)}</td></tr>
